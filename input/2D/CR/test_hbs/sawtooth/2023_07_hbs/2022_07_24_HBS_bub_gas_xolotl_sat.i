...
[ICs]
  ...
  [IC_w]
    ...
    structure_type = voids
    rand_seed = 18765
    invalue = 3.7473 #this corresponds to concentration 0.85
    outvalue = 0.0
  []
  [IC_wg]
    variable = wg
    ...
    structure_type = voids
    rand_seed = 18765
    invalue = -3.7473 #concentration 0.15
    outvalue = -0.8
  []
  [bnds]
    type = BndsCalcIC
...
[Materials]
  ...
  [omegab]
    ...
    function = '-0.5*w^2/Va^2/kb - w/Va*cb_eq - 0.5*wg^2/Va^2/kb - wg/Va*cgb_eq'
    derivative_order = 2
    # outputs = exodus
