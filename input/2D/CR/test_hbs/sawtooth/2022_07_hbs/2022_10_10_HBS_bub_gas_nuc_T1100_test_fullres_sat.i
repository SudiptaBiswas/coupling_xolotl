...
[ICs]
  ...
  [IC_w]
    ...
    structure_type = voids
    rand_seed = 18765
    invalue = 3.6972 #this corresponds to concentration 0.85
    outvalue = 0.0
  []
  [IC_wg]
    variable = wg
    ...
    structure_type = voids
    rand_seed = 18765
    invalue = -3.6972 #concentration 0.15
    outvalue = 0.0
  []
  [bnds]
    type = BndsCalcIC
...
[Materials]
  ...
  [Diff_v]
    ...
    v = 'eta0 eta1 eta2 eta3 eta4 eta5 eta6 eta7 eta8 eta9 eta10 eta11 eta12 eta13 eta14'
    diffusivity = Dv
    Dbulk = 2.019 # this value is obatined from Matzke 1987, cluster dynamics value is in the order of 1e-7
    Dsurf = 2.019
  ...
  [Diff_gm]
    ...
    v = 'eta0 eta1 eta2 eta3 eta4 eta5 eta6 eta7 eta8 eta9 eta10 eta11 eta12 eta13 eta14'
    diffusivity = Dg
    Dbulk = 1.0162e-2 # cluster dynamics data from Mathews 2019, Turnbull value is 0.0215 nm^2/s
    Dsurf = 1.0162e-2
  ...
  [constants]
    ...
    prop_values = '70.2   5.62     4.01e-5 4.01e-4 0.04092   0.563  0.437    236.0     1.5	  1.5   1100  4.81535 '
...
[MultiApps]
  [./sub_app]
    ...
    positions = '0 0 0'
    input_files = 'xolotl_subapp_fullres.i'
