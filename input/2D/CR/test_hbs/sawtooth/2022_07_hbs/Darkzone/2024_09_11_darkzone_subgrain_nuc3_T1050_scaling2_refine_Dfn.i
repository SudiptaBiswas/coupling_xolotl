...
[Materials]
  ...
  [Diff_gm]
    ...
    v = 'eta0 eta1 eta2 eta3 eta4 eta5 eta6 eta7 eta8 eta9 eta10 eta11 eta12 eta13 eta14'
    diffusivity = Dg
    Dbulk = 9.549e-3 # cluster dynamics data from Mathews 2019, Turnbull value is 0.0215 nm^2/s
    Dsurf = 9.549e-3
  ...
  [constants]
    ...
    prop_names = 'kappa   mu        L      Lv      Va        cb_eq  cgb_eq    kb      kgb      gmb    gmm    T    f0   '
                 '  kB           burg_vec  G_mod YXe  Dg0       Dv0'
    prop_values = '70.22   5.6178   9.97e-6 9.97e-5 0.04092   1.0    1.008  245.0   40.93    1.5	  1.5   1050  -20.25 '
                  '8.6173324e-5   0.5      400.0 0.25 9.549e-3 1.67'
  []
