...
[Materials]
  ...
  [Diff_v]
    ...
    v = 'eta0 eta1 eta2 eta3 eta4 eta5 eta6 eta7 eta8 eta9 eta10 eta11 eta12 eta13 eta14'
    diffusivity = Dv
    Dbulk = 0.1605 # this value is obatined from Matzke 1987, cluster dynamics value is in the order of 1e-7
    Dsurf = 0.1605
    surf_weight = 10.0 # 30 is the ptefactor for normalizing the function
    gb_weight = 100.0 # 9 is the ptefactor for normalizing the function
    bulk_weight = 1.0
    void_weight = 100.0
    Dgb = 0.1605
    Dvoid = 0.1605
  ...
  [Diff_gm]
    ...
    v = 'eta0 eta1 eta2 eta3 eta4 eta5 eta6 eta7 eta8 eta9 eta10 eta11 eta12 eta13 eta14'
    diffusivity = Dg
    Dbulk = 9.351e-3 # cluster dynamics data from Mathews 2019, Turnbull value is 0.0215 nm^2/s
    Dsurf = 9.351e-3
    surf_weight = 1000.0 # 30 is the ptefactor for normalizing the function
    gb_weight = 10000.0 # 9 is the ptefactor for normalizing the function
    bulk_weight = 1.0
    void_weight = 10000.0
    Dgb = 9.351e-3
    Dvoid = 9.351e-3
  ...
  [constants]
    ...
    prop_values = '70.2   5.62     2.16e-6 2.16e-5 0.04092   0.563  0.437    212.24     1.5	  1.5   1000  4.32042 '
                  '8.6173324e-5   0.5      400.0 0.2156'
  []
...
[MultiApps]
  [./sub_app]
    ...
    positions = '0 0 0'
input_files = 'xolotl_subapp_test.i'
