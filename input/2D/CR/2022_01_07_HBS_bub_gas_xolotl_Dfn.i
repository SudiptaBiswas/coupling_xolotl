...
[ICs]
  ...
  #   outvalue = 2.526 # concentration 0.05
  # []
  # [IC_wg]
  #   variable = wg
  #   type = PolycrystalVoronoiVoidIC
...
[Materials]
  ...
  [Diff_v]
    ...
    Dsurf = 16.65271
    surf_weight = 0.0 # 30 is the ptefactor for normalizing the function
    gb_weight = 0.0 # 9 is the ptefactor for normalizing the function
    bulk_weight = 1.0
    surfindex = 10
    gbindex = 10
    bulkindex = 1
  ...
  [constants]
    ...
    # prop_values = '140.45   2.81    2.29e-5 2.29e-4 0.04092   0.562  0.438    245.0     1.5	  1.5   1200  5.31579 '
    #               '8.6173324e-5   0.5      400.0 0.2156'
  []
  ...
  [./VacRate_ref]
    ...
    material_property_names = 'Va hm'
    constant_names = 's0'
    constant_expressions = '4.7e-8'  # in atoms/(nm^3 * s)
    args = 'time'
    function = 'if(time < 0, 0, s0 * hm)'
    outputs = exodus
  [../]
