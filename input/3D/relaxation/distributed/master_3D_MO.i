...
[Materials]
  ...
  [./VacRate_ref]
    type = ParsedMaterial
    f_name = VacRate0
    material_property_names = 'YXe XeRate_ref'
    function = 'XeRate_ref / YXe'
  [../]
  ...
  [./hb]
    ...
    h_name = hb
    all_etas = 'bubble etam0 etam1 etam2 etam3 etam4 etam5 etam6 etam7 etam8 etam9 etam10 etam11 etam12 etam13 etam14 etam15 etam16 etam17 etam18 etam19 etam20 etam21 etam22 etam23 etam24'
    phase_etas = 'bubble'
  [../]
  [./hm]
    type = SwitchingFunctionMultiPhaseMaterial
